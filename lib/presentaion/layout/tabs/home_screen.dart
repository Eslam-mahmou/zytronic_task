...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<HomeChatCubit, HomeState>(
      bloc: viewmodel..loadUsers()..loadChats(AppConstant.userId),
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    leading: CircleAvatar(
                      ...
                      child: Text(
                        chat.anotherPerson.name.isNotEmpty ? chat.anotherPerson.name[0].toUpperCase() : "?",
                        style: const TextStyle(color: AppColors.primaryColor),
                      ),
                    ),
                    title: Text(chat.anotherPerson.name, style: theme.textTheme.titleMedium),
                    subtitle:Text(
                      chat.lastMessage,
